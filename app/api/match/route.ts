...
const PROVIDERS = [
  ...
  {
    id: 'manchester-food-hub',
    name: 'Manchester Food Hub',
    type: 'shared_kitchen',
    cities: ['Manchester'],
    priceMin: 15,
    priceMax: 45,
    priceUnit: 'hour',
    equipment: ['Commercial oven', 'Gas hobs / Range', 'Mixer', 'Prep tables', 'Upright fridge'],
    features: ['Central Manchester', 'Food business community', 'Networking events'],
    bestForBusiness: ['starting', 'catering', 'popup', 'production'],
    bestForScale: ['small', 'medium'],
    bestForBudget: ['under-500', '500-1000', '1000-2000'],
    cuisineStrength: ['all'],
    website: 'https://manchesterfoodhub.co.uk',
    description: 'Manchester food business community with shared kitchen facilities and networking opportunities.'
  },
  {
