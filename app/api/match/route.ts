...
const PROVIDERS_FALLBACK = [
  ...
  },
  {
    ...
    bestForBusiness: ['popup', 'starting', 'catering', 'retail'],
    bestForScale: ['small', 'medium', 'large'],
    bestForBudget: ['500-1000', '1000-2000', '2000-5000'],
    cuisineStrength: ['Burgers', 'Street Food', 'Pub Food', 'Pizza', 'Chicken & Chips'],
    website: 'https://www.oya.co.uk',
    description: 'Property marketplace for the food industry. Browse pubs, restaurants and commercial spaces looking for food operators. Great for pub kitchen residencies with built-in customer base.'
  },
  {
    id: 'spaceandpeople',
    name: 'SpaceandPeople',
    ...
    bestForBusiness: ['popup', 'retail', 'starting'],
    bestForScale: ['small', 'medium'],
    bestForBudget: ['500-1000', '1000-2000', '2000-5000'],
    cuisineStrength: ['Coffee & Café', 'Street Food', 'Desserts & Bakery', 'Healthy / Salads'],
    website: 'https://www.spaceandpeople.co.uk',
    description: 'Access to shopping centres and train stations across UK. Kiosks, pop-up spaces, and mall pitches with massive footfall. Good for brands ready to scale into retail environments.'
  },
  {
    ...
    bestForBusiness: ['mobile', 'popup', 'catering'],
    bestForScale: ['small', 'medium'],
    bestForBudget: ['under-500', '500-1000'],
    cuisineStrength: ['Street Food', 'Burgers', 'BBQ', 'Mexican', 'Asian'],
    website: 'https://streetfoodwarehouse.co.uk/apply-to-trade/',
    description: 'Festival and event trader network. Join their free database to get pitched for weddings, corporate events, and festivals nationwide. Great for seasonal income.'
  },
  {
    ...
    bestForScale: ['small', 'medium'],
    bestForBudget: ['under-500', '500-1000'],
    cuisineStrength: ['Street Food', 'British', 'BBQ', 'Artisan'],
    website: 'https://greatbritishfoodfestival.com/traders/',
    description: 'UK food festival circuit with pitches from £128/day. Events at stately homes and venues across the country. Good footfall, family audiences, summer season focus.'
  },
  {
    id: 'storefront',
    name: 'Storefront',
    ...
    bestForScale: ['small', 'medium'],
    bestForBudget: ['under-500', '500-1000', '1000-2000'],
    cuisineStrength: ['Street Food', 'Coffee & Café', 'Desserts & Bakery'],
    website: 'https://www.thestorefront.com',
    description: 'Global marketplace for short-term retail spaces. Find food stalls, kiosks, and market pitches for pop-ups. Book by the day or week.'
  },
  {
    ...
    bestForBusiness: ['mobile', 'popup'],
    bestForScale: ['small', 'medium'],
    bestForBudget: ['under-500', '500-1000'],
    cuisineStrength: ['Street Food', 'Burgers', 'BBQ', 'Asian', 'Mexican'],
    website: 'https://digbethdiningclub.com/',
    description: 'Multi-award-winning Birmingham street food organisation. Apply to trade at their events. Competitive (75% rejection rate) but excellent platform if accepted.'
  },
  {
    id: 'leeds-kirkgate',
    ...
    bestForScale: ['small', 'medium'],
    bestForBudget: ['under-500', '500-1000'],
    cuisineStrength: ['Street Food', 'British', 'International', 'Coffee & Café'],
    website: 'https://markets.leeds.gov.uk/trade-our-markets/trade-kirkgate-market',
    contactEmail: 'markets@leeds.gov.uk',
    description: 'Historic Leeds market with new trader incentive: 2 weeks half price, 2 weeks free! Council-run with transparent process. Great for testing concepts.'
  },
  {
    ...
    bestForBusiness: ['starting', 'popup', 'mobile'],
    bestForScale: ['small', 'medium'],
    bestForBudget: ['under-500', '500-1000'],
    cuisineStrength: ['Street Food', 'International', 'Coffee & Café', 'Vegan / Vegetarian'],
    website: 'https://www.bristol.gov.uk/st-nicholas-markets/trade-with-us',
    description: 'Bristol\'s iconic market with multiple trading options — Street Food Market, Indies Market, and Corn Exchange. Level 2 hygiene required. Council-run with clear application.'
  },
  {
    ...
    bestForBusiness: ['starting', 'popup', 'mobile'],
    bestForScale: ['small'],
    bestForBudget: ['under-500'],
    cuisineStrength: ['Street Food', 'Scottish', 'Coffee & Café', 'Artisan'],
    website: 'https://www.stockbridgemarket.com',
    contactEmail: 'traderstall@aol.com',
    description: 'Popular Edinburgh markets across three locations. Same management, so success at one can lead to spots at others. Email directly to enquire.'
  },
